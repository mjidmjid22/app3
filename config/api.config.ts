...
export const API_CONFIG = {
  ...
  PRODUCTION_URL: process.env.EXPO_PUBLIC_API_URL || 'https://mantaeuvert-3aakv3rcz-hamza-mjids-projects.vercel.app',
  
  // Get current API URL based on environment
  BASE_URL: process.env.EXPO_PUBLIC_API_URL || (isProduction 
    ? 'https://mantaeuvert-3aakv3rcz-hamza-mjids-projects.vercel.app'
